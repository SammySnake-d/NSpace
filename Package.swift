...
let pods: [String] = ["DirectoryReader", "Transfer", "PathComplete", "DirectoryWatch", "FolderSize", "IconThumb", "LocalOps", "VolumeInfo", "BookmarkStore", "SessionStore", "StashStore", "SearchEngine", "ArchiveEngine", "UpdateEngine", "Frecency"]
